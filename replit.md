...
- **AI Integration**: Leverages OpenAI models (gpt-4o for Premium, gpt-4o-mini for Econ̫mico) via Replit AI Integrations, and Gemini 2.5 Flash/Pro for specialized tasks.
...
- **ComunicaAPI (CNJ)**: API for sending/receiving court communications.
  ...
  - Endpoints: autentica̤̣o, envio de comunica̵̤es, consulta de comunica̵̤es, certid̵es em PDF
