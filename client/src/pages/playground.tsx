...
<body>
<div id="output"><span class="info">â³ Carregando Python WebAssembly...
(apenas na 1Âª vez â depois fica no cache do navegador)</span></div>
...
async function run(){
  ...
  try {
    ...
    out.innerHTML = '<span class="ok">â Python pronto</span>\\n';
    pyodide.runPython(\`
import sys, io
...
\`);
    ...
    if (!stdout && !stderr) out.innerHTML += '<span class="info">(sem saÃ­da â use print() para mostrar resultados)</span>';
  } catch(e) {
