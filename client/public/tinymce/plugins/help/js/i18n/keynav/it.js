...
'<h1>Iniziare la navigazione tramite tastiera</h1>\n' +
  ...
  '  <dd>macOS: &#x2325;F10</dd>\n' +
  '  <dt>Impostare lo stato attivo per il piÃ¨ di pagina</dt>\n' +
  ...
  '</dl>\n' +
  '\n' +
  "<p>La navigazione inizierÃ  dalla prima voce dell'interfaccia utente, che sarÃ  evidenziata o sottolineata nel caso della prima voce\n" +
  "  nel percorso dell'elemento del piÃ¨ di pagina.</p>\n" +
  '\n' +
  ...
  '\n' +
  "<p>L'ordine di <strong>tabulazione</strong> di queste sezioni dell'interfaccia utente Ã¨:</p>\n" +
  '\n' +
  '<ol>\n' +
  '  <li>Barra dei menu</li>\n' +
  '  <li>Ogni gruppo di barre degli strumenti</li>\n' +
  '  <li>Barra laterale</li>\n' +
  "  <li>Percorso dell'elemento nel piÃ¨ di pagina</li>\n" +
  '  <li>Pulsante di attivazione/disattivazione del conteggio delle parole nel piÃ¨ di pagina</li>\n' +
  '  <li>Collegamento al marchio nel piÃ¨ di pagina</li>\n' +
  "  <li>Quadratino di ridimensionamento dell'editor nel piÃ¨ di pagina</li>\n" +
  '</ol>\n' +
  '\n' +
  "<p>Se una sezione dell'interfaccia utente non Ã¨ presente, viene saltata.</p>\n" +
  '\n' +
  '<p>Se il piÃ¨ di pagina ha lo stato attivo per la navigazione tramite tastiera e non Ã¨ presente alcuna barra laterale visibile, premendo <strong>MAIUSC+TAB</strong>\n' +
  ...
  "  <li>consentono di spostarsi tra le voci nel percorso dell'elemento del piÃ¨ di pagina.</li>\n" +
  '</ul>\n' +
  '\n' +
  '<p>I tasti freccia <strong>GiÃ¹</strong> e <strong>Su</strong></p>\n' +
  '\n' +
  '<ul>\n' +
